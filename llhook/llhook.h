...
#ifdef WIN64
const wchar_t szClientWindowClassName_[] = L"FastSnippingWindowClassName64";
#else
const wchar_t szClientWindowClassName_[] = L"FastSnippingWindowClassName";
#endif
...
const int MSG_COMMAND_1 = WM_USER + 6;
